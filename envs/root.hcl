...
inputs = {
  ...
  wafv2_aws_managed_rule_group_names                        = ["AWSManagedRulesCommonRuleSet", "AWSManagedRulesAmazonIpReputationList"]
  wafv2_aws_managed_rule_group_override_action              = {}
  wafv2_aws_managed_rule_group_rule_action_override_actions = {}
